...
<p>臺灣健保預檢規則實作指引（Taiwan NHI Clinical Quality Language Implementation Guide，TWNHIA CQL IG）係採用 HL7® FHIR® （Fast Healthcare Interoperability Resources）與 HL7® CQL （Clinical Quality Language）之標準建置方法，並以「臺灣健保癌症用藥事前審查實作指引」（Taiwan NHI Cancer Prior Authorization Support Implementation Guide，TWPAS IG）為基礎，進一步定義符合「癌藥預檢規則」邏輯需求之 CQL Library （邏輯模組）。</p>
...
<tr>
    <td>作者-IG</td>
    <td>李奇安</td>
    <td rowspan="1" style="vertical-align: middle;">資拓宏宇</td>
</tr>
       <tr>
            <td>貢獻者-IG</td>
            <td>張如薰</td>
